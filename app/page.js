export default function Page() {
  ...
  <header id="top" className="cover"><div className="shell">
    <div className="masthead"><span>Berco — Custom Interiors</span><span>Philippines</span></div>
    <div className="coverimg ph pa">
      <div className="grain"></div>
      <span className="cap">Kitchen · design reference</span>
      <div className="type">
        <div className="eyebrow">The Heart of Your Home</div>
  ...
  <section id="collections" className="band"><div className="shell">
    <div className="sh reveal"><h2>Cabinetry, by space.</h2><span className="eyebrow">What we make</span></div>
    <div className="mag reveal">
      <a className="tile ph pa t-k" href="#book"><div className="grain"></div><div className="lbl"><span className="cn">Kitchens</span><span className="go">Explore →</span></div></a>
      <a className="tile ph pb t-w" href="#book"><div className="grain"></div><div className="lbl"><span className="cn">Wardrobes</span><span className="go">Explore →</span></div></a>
      <a className="tile ph pc t-l" href="#book"><div className="grain"></div><div className="lbl"><span className="cn">Living &amp; Media</span><span className="go">Explore →</span></div></a>
      <a className="tile ph pd t-b" href="#book"><div className="grain"></div><div className="lbl"><span className="cn">Bedrooms</span><span className="go">Explore →</span></div></a>
      <a className="tile ph pe t-ba" href="#book"><div className="grain"></div><div className="lbl"><span className="cn">Bathrooms</span><span className="go">Explore →</span></div></a>
      <a className="tile ph pf t-d" href="#book"><div className="grain"></div><div className="lbl"><span className="cn">Dining</span><span className="go">Explore →</span></div></a>
    </div>
  </div></section>
  
  <section className="feature ph pg reveal">
    <div className="grain"></div>
  ...
  <section id="process" className="band"><div className="shell">
    <div className="sh reveal"><h2>Four steps, in order.</h2><span className="eyebrow">How we work</span></div>
  ...
  <section id="precision" className="prec band"><div className="shell">
    <div className="sh reveal"><h2>Made with precision.</h2><span className="eyebrow">Materials</span></div>
    <div className="chips reveal">
      <span className="chip"><b>E1</b> low-emission board</span>
      <span className="chip"><b>Blum &amp; Hettich</b> soft-close</span>
      <span className="chip"><b>Quartz</b> surfaces</span>
      <span className="chip"><b>Kesseböhmer &amp; Peka</b> fitted storage</span>
      <span className="chip"><b>German</b> machinery</span>
    </div>
