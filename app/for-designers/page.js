...
const DOWNLOADS = [
  ...
  { t: 'Materials & Finishes 2026', d: 'Part One is the selection — 54 finishes edited down to a working palette to put in front of a client. Part Two is the complete range, all 202, grouped by the material each is made from: melamine, film, lacquer, high-gloss UV, powder-coat, PET, veneer, leather, quartz and sintered stone worktops, and carcase panels. Every swatch carries its material code, so a finish can be scheduled and checked against the specification directly. Room approvals, care notes and an A–Z index at the back.', href: '/catalogues/materials-finishes', meta: 'PDF · 28pp', cover: '/img/covers/materials-finishes-cover.jpg', coverAlt: 'Cover of the Berco Materials and Finishes 2026 library' },
]
