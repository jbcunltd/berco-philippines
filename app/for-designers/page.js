...
const DOWNLOADS = [
  ...
  { t: 'Materials & Finishes 2026', d: 'Part One is the selection — 54 finishes edited down to a working palette to put in front of a client. Part Two is the complete range, all 202, grouped by the material each is made from: melamine, film, lacquer, high-gloss UV, powder-coat, PET, veneer, leather, quartz and sintered stone worktops, and carcase panels. Every finish carries a Berco reference code for scheduling. Room approvals, care notes and an A–Z index at the back.', href: '/berco-materials-finishes-2026.pdf', meta: 'PDF · 28pp' },
]
